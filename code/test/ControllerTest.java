...
/**
 * In controller test, we make each method return an integer 0, so if the method go to the end, it
 * will return 0. We assert every controller method call to be 0 so that we can make sure it goes to
 * the end and all functions work fine.
 */
